...
package dev.lounres.kone.plugin.contextsKeys.services

import dev.lounres.kone.plugin.contextsKeys.fir.DeclarationExtensionRegistrar
import dev.lounres.kone.plugin.contextsKeys.fir.DiagnosticExtensionRegistrar
...
import dev.lounres.kone.plugin.contextsKeys.ir.TestIrGenerationExtension
...
//        val messageCollector = configuration.get(CommonConfigurationKeys.MESSAGE_COLLECTOR_KEY, MessageCollector.NONE)
        ...
        IrGenerationExtension.registerExtension(
            ContextsKeysIrGenerationExtension(
                lastPhase = lastPhase
            )
        )
    }
