...
package dev.lounres.kone.plugin.contextsKeys.runners

import dev.lounres.kone.plugin.contextsKeys.services.FirCompleteExtensionRegistrarConfigurator
import dev.lounres.kone.plugin.contextsKeys.services.FirDeclarationsConfigurator
import dev.lounres.kone.plugin.contextsKeys.services.FirDiagnosticConfigurator
...
open class AbstractFrontendTest(private val pluginConfigurator: Constructor<EnvironmentConfigurator>) : KoneContextsKeysTestRunner() {
