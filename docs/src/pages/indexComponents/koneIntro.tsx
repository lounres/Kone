                ...
                <h1 className="hero__title">
                    <Translate
                        ...
                        values={{
                            ...
                            mathComputerExperimentsHighlight: (<Link href={`${siteConfig.baseUrl}docs/`} className={styles.link}>math computer experiments</Link>),
                        }}
                    >
                        {
                            `Kone is a set of {kotlinMultiplatformLink} libraries
                            that are made to simplify your experience of {mathComputerExperimentsHighlight}`
                        }
                    </Translate>
