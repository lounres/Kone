...
internal class VectorEquality<N>(val columnVectorEquality: Equality<ColumnVector<N>>) : Equality<Vector<N>> {
    override fun Vector<N>.equalsTo(other: Vector<N>): Boolean = context(columnVectorEquality) { this.coordinates eq other.coordinates }
}
...
internal class VectorHashing<N>(val columnVectorHashing: Hashing<ColumnVector<N>>) : Hashing<Vector<N>> {
    override fun Vector<N>.hash(): Int = context(columnVectorHashing) { this.coordinates.hash() }
}
