...
import dev.lounres.kone.polynomial.testUtils.assertFailsWithTypeAndMessage
...
class ListPolynomialUtilTest : AnnotationSpec() {
    ...
    fun test_Polynomial_substitute_Constant() {
        assertEquals(
            Rational(0),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).substitute(Rational.field, Rational(1)),
            "test 1"
        )
        assertEquals(
            Rational(25057, 21000),
            ListPolynomial(Rational(5, 8), Rational(8, 3), Rational(4, 7), Rational(3, 2))
                .substitute(Rational.field, Rational(1, 5)),
            "test 2"
        )
        assertEquals(
            Rational(2983, 5250),
    ...
    fun test_Polynomial_substitute_Polynomial() {
        assertEquals(
            ...
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).substitute(Rational.field, ListPolynomial(Rational(1))),
            "test 1"
        )
        assertEquals(
            ...
            ListPolynomial(Rational(1, 7), Rational(9, 4), Rational(1, 3), Rational(2, 7))
                .substitute(Rational.field, ListPolynomial(Rational(6, 9), Rational(1, 5))),
            "test 2"
        )
        assertEquals(
        ...
        assertEquals(
            ...
            ListPolynomial(Rational(0), Rational(9, 4), Rational(1, 3), Rational(0))
                .substitute(Rational.field, ListPolynomial(Rational(6, 9), Rational(0))),
            "test 6"
        )
    }
    @Test
    ...
    fun test_Polynomial_substitute_RationalFunction() {
        assertEquals(
            ...
            ListPolynomial(Rational(1), Rational(-2), Rational(1))
                .substitute(Rational.field, ListRationalFunction(ListPolynomial(Rational(1)), ListPolynomial(Rational(1)))),
            "test 1"
        )
        assertEquals(
    ...
    fun test_RationalFunction_substitute_Constant() {
        assertEquals(
            ...
            ).substitute(Rational.field, Rational(1)),
            "test 1"
        )
        assertEquals(
            ...
            ).substitute(Rational.field, Rational(-7, 8)),
            "test 2"
        )
        assertEquals(
            Rational(3495, 586),
    ...
    fun test_RationalFunction_substitute_Polynomial() {
        assertEquals(
            ...
            ListRationalFunction(
                ListPolynomial(Rational(1), Rational(-2), Rational(1)),
                ListPolynomial(Rational(1)),
            ).substitute(Rational.field, ListPolynomial(Rational(1))),
            "test 1"
        )
        assertEquals(
            ListRationalFunction(
    ...
    fun test_Polynomial_derivative() {
        assertEquals(
            ...
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).derivative(Rational.field),
            "test 1"
        )
        assertEquals(
            ListPolynomial(Rational(-8, 3), Rational(8, 9), Rational(15, 7), Rational(-20, 9)),
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).derivative(
                Rational.field
            ),
            "test 2"
        )
        assertEquals(
            ...
            ListPolynomial(Rational(0), Rational(0), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).derivative(
                Rational.field
            ),
            "test 3"
        )
        assertEquals(
            ...
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(0)).derivative(
                Rational.field
            ),
            "test 4"
        )
    ...
    fun test_Polynomial_nthDerivative() {
        assertEquals(
            ListPolynomial(Rational(-2), Rational(2)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthDerivative(Rational.field, 1),
            "test 1"
        )
        ...
        assertEquals(
            ListPolynomial(Rational(1), Rational(-2), Rational(1)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthDerivative(Rational.field, 0),
            "test 3"
        )
        assertEquals(
            ListPolynomial(Rational(2)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthDerivative(Rational.field, 2),
            "test 4"
        )
        assertEquals(
            ListPolynomial(),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthDerivative(Rational.field, 3),
            "test 5"
        )
        assertEquals(
            ListPolynomial(),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthDerivative(Rational.field, 4),
            "test 6"
        )
        assertEquals(
            ListPolynomial(Rational(8, 9), Rational(30, 7), Rational(-20, 3)),
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).nthDerivative(
                Rational.field, 2),
            "test 7"
        )
        assertEquals(
            ListPolynomial(Rational(8, 9), Rational(30, 7), Rational(-20, 3)),
            ListPolynomial(Rational(0), Rational(0), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).nthDerivative(
                Rational.field, 2),
            "test 8"
        )
        assertEquals(
            ListPolynomial(Rational(8, 9), Rational(30, 7), Rational(0)),
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(0)).nthDerivative(
                Rational.field, 2),
            "test 9"
        )
    }
    ...
    fun test_Polynomial_antiderivative() {
        assertEquals(
            ...
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).antiderivative(Rational.field),
            "test 1"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(1, 5), Rational(-4, 3), Rational(4, 27), Rational(5, 28), Rational(-1, 9)),
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).antiderivative(
                Rational.field
            ),
            "test 2"
        )
        assertEquals(
            ...
            ListPolynomial(Rational(0), Rational(0), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).antiderivative(
                Rational.field
            ),
            "test 3"
        )
        assertEquals(
            ...
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(0)).antiderivative(
                Rational.field
            ),
            "test 4"
        )
    ...
    fun test_Polynomial_nthAntiderivative() {
        assertEquals(
            ListPolynomial(Rational(0), Rational(1), Rational(-1), Rational(1, 3)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthAntiderivative(Rational.field, 1),
            "test 1"
        )
        assertFailsWithTypeAndMessage<IllegalArgumentException>(
        ...
        assertEquals(
            ListPolynomial(Rational(1), Rational(-2), Rational(1)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthAntiderivative(Rational.field, 0),
            "test 3"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(0), Rational(1, 2), Rational(-1, 3), Rational(1, 12)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthAntiderivative(Rational.field, 2),
            "test 4"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(0), Rational(0), Rational(1, 6), Rational(-1, 12), Rational(1, 60)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthAntiderivative(Rational.field, 3),
            "test 5"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(0), Rational(0), Rational(0), Rational(1, 24), Rational(-1, 60), Rational(1, 360)),
            ListPolynomial(Rational(1), Rational(-2), Rational(1)).nthAntiderivative(Rational.field, 4),
            "test 6"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(0), Rational(1, 10), Rational(-4, 9), Rational(1, 27), Rational(1, 28), Rational(-1, 54)),
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).nthAntiderivative(
                Rational.field, 2),
            "test 7"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(0), Rational(0), Rational(0), Rational(1, 27), Rational(1, 28), Rational(-1, 54)),
            ListPolynomial(Rational(0), Rational(0), Rational(4, 9), Rational(5, 7), Rational(-5, 9)).nthAntiderivative(
                Rational.field, 2),
            "test 8"
        )
        assertEquals(
            ListPolynomial(Rational(0), Rational(0), Rational(1, 10), Rational(-4, 9), Rational(1, 27), Rational(1, 28), Rational(0)),
            ListPolynomial(Rational(1, 5), Rational(-8, 3), Rational(4, 9), Rational(5, 7), Rational(0)).nthAntiderivative(
                Rational.field, 2),
            "test 9"
        )
    }
