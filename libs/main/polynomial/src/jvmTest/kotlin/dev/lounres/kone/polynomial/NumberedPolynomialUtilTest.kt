...
import dev.lounres.kone.polynomial.testUtils.bufferOf
    ...
    fun test_Polynomial_substitute_Constant_Map() {
        ...
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(18, 9),
                listOf(2u, 2u) to Rational(5, 2),
            ).substitute(Rational.field, mapOf<Int, Rational>()),
            "test 5"
        )
        assertEquals(
            NumberedPolynomialAsIs(
    ...
    fun test_Polynomial_substitute_Polynomial_Map() {
        ...
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(18, 9),
                listOf(2u, 2u) to Rational(5, 2),
            ).substitute(Rational.field, mapOf<Int, NumberedPolynomial<Rational>>()),
            "test 6"
        )
        assertEquals(
            NumberedPolynomialAsIs(
    ...
    fun test_Polynomial_substitute_RationalFunction_Map() {
        ...
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(-17, 6),
                listOf(2u, 2u) to Rational(-6, 2),
            ).substitute(Rational.field, mapOf<Int, NumberedRationalFunction<Rational>>()),
            "test 6"
        )
        assertEquals(
            NumberedRationalFunction(
    ...
    fun test_Polynomial_substitute_Constant_Buffer() {
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u) to Rational(-2),
                listOf(2u) to Rational(1)
            ).substitute(Rational.field, bufferOf(
                Rational(1)
            )
            ),
            "test 1"
        ...
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(18, 9),
                listOf(2u, 2u) to Rational(5, 2),
            ).substitute(Rational.field, bufferOf<Rational>()),
            "test 2"
        )
        // https://www.wolframalpha.com/input?i=%28-3%2F2+%2B+8%2F6+x+%2B+14%2F6+x%5E2%29+%2B+%28-3%2F1+%2B+-19%2F2+x+%2B+9%2F4+x%5E2%29+y+%2B+%285%2F5+%2B+18%2F9+x+%2B+5%2F2+x%5E2%29+y%5E2+where+x+%3D+-2%2F5
        assertEquals(
    ...
    fun test_Polynomial_substitute_Polynomial_Buffer() {
        ...
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(18, 9),
                listOf(2u, 2u) to Rational(5, 2),
            ).substitute(Rational.field, bufferOf<NumberedPolynomial<Rational>>()),
            "test 6"
        )
    }
    @Test
    ...
    fun test_Polynomial_substitute_RationalFunction_Buffer() {
        ...
        assertEquals(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(-17, 6),
                listOf(2u, 2u) to Rational(-6, 2),
            ).substitute(Rational.field, bufferOf<NumberedRationalFunction<Rational>>()),
            "test 6"
        )
    }
    @Test
    ...
    fun test_Polynomial_substituteFully_Constant_Buffer() {
        ...
        assertFailsWithTypeAndMessage<IllegalArgumentException>(
            ...
            NumberedPolynomialAsIs(
                ...
                listOf(1u, 2u) to Rational(18, 9),
                listOf(2u, 2u) to Rational(5, 2),
            ).substituteFully(Rational.field, bufferOf())
        }
        assertFailsWithTypeAndMessage<IllegalArgumentException>(
            fullSubstitutionExceptionMessage,
            "test 3"
