...
class KoneConcurrentSundellTsigasNoddedDequeueCleanedConcurrencyTest {
    ...
    private val nodesDequeue = KoneListBackedDeque<KoneConcurrentSundellTsigasNoddedDequeueCleaned.Node<Element>>()
...
//
//        scope {
//            val nodes = mutableSetOf<KoneConcurrentSundellTsigasNoddedDequeueCleaned.Node<Element>>()
