...
/**
 * An operation context that checks whether an element is equal to zero.
 *
 * @param Input The type of elements to check.
 */
public interface IsZero<in Input> : KoneContext {
    /**
     * Returns `true` if [this] element equals zero.
     *
    ...
    /**
     * Registry key for [IsZero] interface in [Registry].
     *
     * @param Input The type of elements to check.
     */
    @Suppliable
...
/**
 * Creates an [IsZero] instance from a lambda.
 *
 * @param Input The type of elements to check.
 * @param block The predicate returning `true` if the argument is zero.
 * @return A new [IsZero] instance.
 */
...
/**
 * Checks if [this] element is zero using the given [IsZero] context.
 *
 * @param isZero The context providing the zero-check operation.
 * @receiver The element to check.
 * @param Input The type of elements to check.
 * @return `true` if this element is zero, `false` otherwise.
 */
...
// FIXME: KT-5351
/**
 * Checks if [this] element is not zero using the given [IsZero] context.
 *
 * @param isZero The context providing the zero-check operation.
 * @receiver The element to check.
 * @param Input The type of elements to check.
 * @return `true` if this element is not zero, `false` otherwise.
 */
context(isZero: IsZero<Input>)
public fun <Input> Input.isNotZero(): Boolean = with(isZero) { !this@isNotZero.isZero() }

/**
 * An operation context that checks whether an element is equal to one.
 *
 * @param Input The type of elements to check.
 */
public interface IsOne<in Input> : KoneContext {
    /**
     * Returns `true` if [this] element equals one.
     *
     * @receiver The element to check.
     * @return `true` if this element is one, `false` otherwise.
     */
    public fun Input.isOne(): Boolean
    
    /**
     * Registry key for [IsOne] interface in [Registry].
     *
     * @param Input The type of elements to check.
     */
    @Suppliable
...
/**
 * Creates an [IsOne] instance from a lambda.
 *
 * @param Input The type of elements to check.
 * @param block The predicate returning `true` if the argument is one.
 * @return A new [IsOne] instance.
 */
...
/**
 * Checks if [this] element is one using the given [IsOne] context.
 *
 * @param isOne The context providing the one-check operation.
 * @receiver The element to check.
 * @param Input The type of elements to check.
 * @return `true` if this element is one, `false` otherwise.
 */
...
// FIXME: KT-5351
/**
 * Checks if [this] element is not one using the given [IsOne] context.
 *
 * @param isOne The context providing the one-check operation.
 * @receiver The element to check.
 * @param Input The type of elements to check.
 * @return `true` if this element is not one, `false` otherwise.
 */
context(isOne: IsOne<Input>)
