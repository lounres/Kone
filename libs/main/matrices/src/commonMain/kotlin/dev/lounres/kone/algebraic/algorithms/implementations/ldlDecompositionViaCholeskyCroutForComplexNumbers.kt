...
private class LDLDecompositionViaCholeskyCroutForComplexNumbers<Number, Matrix : MDList2<ComplexNumber<Number>>>(
    ...
    override fun Matrix.ldlDecomposition(): LDLDecomposition<ComplexNumber<Number>, Matrix> {
        ...
        for (j in 0u ..< n) {
            val sum = (0u ..< j).asKoneSequence().sumOf<_, ComplexNumber<Number>> { l[j, it].norm() * d[it] }
...
public fun <Number, Matrix : MDList2<ComplexNumber<Number>>> LDLDecompositionComputer.Companion.viaCholeskyCroutForComplexNumbers(
...
): LDLDecompositionComputer<ComplexNumber<Number>, Matrix> = LDLDecompositionViaCholeskyCroutForComplexNumbers(
...
public object LDLDecompositionComputerLDLCroutForComplexNumbersSuppliableTopLevelFunctions {
    @Suppliable
    context(koneContextRegistry: KoneContextRegistry.Provider)
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> LDLDecompositionComputer.Companion.viaCholeskyCroutForComplexNumbers(): LDLDecompositionComputer<ComplexNumber<Number>, Matrix> {
        ...
        return viaCholeskyCroutForComplexNumbers(
            matrixFactory = koneContextRegistry.requestFor(MatrixFactory.Key<ComplexNumber<Number>, Matrix>()) {
                "LDLDecompositionComputer.viaCholeskyCroutForComplexNumbers<${suppliedTypeOf<Number>()}, ${suppliedTypeOf<Matrix>()}>"
            },
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> LDLDecompositionComputer.Companion.setViaCholeskyCroutForComplexNumbers(
        matrixFactory: MatrixFactory<ComplexNumber<Number>, Matrix>,
        numberField: Field<Number>,
        complexNumberFieldExtension: FieldExtension<Number, ComplexNumber<Number>>,
        conjugateTransposeMatrixComputer: ConjugateTransposeMatrixComputer<Number, Matrix>,
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> LDLDecompositionComputer.Companion.useViaCholeskyCroutForComplexNumbers(
        ...
        LDLDecomposition.Key<ComplexNumber<Number>, MatrixWithProperties<ComplexNumber<Number>, Matrix>>() correspondsTo RegisteredValueProvider.cached {
            val ldlDecompositionComputer = viaCholeskyCroutForComplexNumbers(
                matrixFactory = matrixFactory,
                numberField = numberField,
                complexNumberFieldExtension = complexNumberFieldExtension,
                conjugateTransposeMatrixComputer = conjugateTransposeMatrixComputer,
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> LDLDecompositionComputer.Companion.useViaCholeskyCroutForComplexNumbers() {
        LDLDecomposition.Key<ComplexNumber<Number>, MatrixWithProperties<ComplexNumber<Number>, Matrix>>() correspondsTo RegisteredValueProvider.cached {
            val ldlDecompositionComputer = viaCholeskyCroutForComplexNumbers<Number, MatrixWithProperties<ComplexNumber<Number>, Matrix>>()
            ldlDecompositionComputer { matrix.get().ldlDecomposition() }
        }
    }
}