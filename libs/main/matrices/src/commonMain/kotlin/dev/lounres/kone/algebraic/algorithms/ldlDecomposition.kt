...
public fun interface LDLDecompositionComputer<out Number, Matrix : MDList2<Number>> : KoneContext {
    ...
    @Suppliable
    public class Key<@Supply Number, @Supply Matrix : MDList2<Number>> : SuppliedTypeRegistryKey<LDLDecompositionComputer<Number, Matrix>>() {
        override fun toString(): String = "dev.lounres.kone.algebraic.algorithms.LDLDecompositionComputer.Key<${suppliedTypeOf<Number>()}, ${suppliedTypeOf<Matrix>()}>"
    }
}
