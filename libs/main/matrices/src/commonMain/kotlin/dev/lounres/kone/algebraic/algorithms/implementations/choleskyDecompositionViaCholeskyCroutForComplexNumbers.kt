...
private class CholeskyDecompositionViaCholeskyCroutForComplexNumbers<Number, Matrix : MDList2<ComplexNumber<Number>>>(
    ...
    override fun Matrix.choleskyDecomposition(): CholeskyDecomposition<ComplexNumber<Number>, Matrix> {
        ...
        for (j in 0u ..< n) {
            val sum = (0u ..< j).asKoneSequence().sumOf<_, Number> { l[j, it].norm() }
            
            l[j, j] = ComplexNumber((this[j, j].realPart - sum).positiveSquareRoot(), numberField.zero)
...
public fun <Number, Matrix : MDList2<ComplexNumber<Number>>> CholeskyDecompositionComputer.Companion.viaCholeskyCroutForComplexNumbers(
...
): CholeskyDecompositionComputer<ComplexNumber<Number>, Matrix> = CholeskyDecompositionViaCholeskyCroutForComplexNumbers(
...
public object CholeskyDecompositionComputerCholeskyCroutForComplexNumbersSuppliableTopLevelFunctions {
    @Suppliable
    context(koneContextRegistry: KoneContextRegistry.Provider)
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> CholeskyDecompositionComputer.Companion.viaCholeskyCroutForComplexNumbers(): CholeskyDecompositionComputer<ComplexNumber<Number>, Matrix> {
        val koneContextRegistry = koneContextRegistry.get()
        return viaCholeskyCroutForComplexNumbers(
            matrixFactory = koneContextRegistry.requestFor(MatrixFactory.Key<ComplexNumber<Number>, Matrix>()) {
                "CholeskyDecompositionComputer.viaCholeskyCroutForComplexNumbers<${suppliedTypeOf<Number>()}, ${suppliedTypeOf<Matrix>()}>"
            },
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> CholeskyDecompositionComputer.Companion.setViaCholeskyCroutForComplexNumbers(
        matrixFactory: MatrixFactory<ComplexNumber<Number>, Matrix>,
        numberField: Field<Number>,
        complexNumberFieldExtension: FieldExtension<Number, ComplexNumber<Number>>,
        positiveSquareRootComputer: PositiveSquareRootComputer<Number>,
        ...
        CholeskyDecompositionComputer.Key<ComplexNumber<Number>, Matrix>() correspondsTo RegisteredValueProvider.cached {
            viaCholeskyCroutForComplexNumbers(
                matrixFactory = matrixFactory,
                numberField = numberField,
                complexNumberFieldExtension = complexNumberFieldExtension,
                positiveSquareRootComputer = positiveSquareRootComputer,
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> CholeskyDecompositionComputer.Companion.setViaCholeskyCroutForComplexNumbers() {
        CholeskyDecompositionComputer.Key<ComplexNumber<Number>, Matrix>() correspondsTo RegisteredValueProvider.cached {
            viaCholeskyCroutForComplexNumbers<Number, Matrix>()
        }
    }
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> CholeskyDecompositionComputer.Companion.useViaCholeskyCroutForComplexNumbers(
        ...
        CholeskyDecomposition.Key<ComplexNumber<Number>, MatrixWithProperties<ComplexNumber<Number>, Matrix>>() correspondsTo RegisteredValueProvider.cached {
            val choleskyDecompositionComputer = viaCholeskyCroutForComplexNumbers(
                matrixFactory = matrixFactory,
                numberField = numberField,
                complexNumberFieldExtension = complexNumberFieldExtension,
                positiveSquareRootComputer = positiveSquareRootComputer,
    ...
    public fun <@Supply Number, @Supply Matrix : MDList2<ComplexNumber<Number>>> CholeskyDecompositionComputer.Companion.useViaCholeskyCroutForComplexNumbers() {
        CholeskyDecomposition.Key<ComplexNumber<Number>, MatrixWithProperties<ComplexNumber<Number>, Matrix>>() correspondsTo RegisteredValueProvider.cached {
            val choleskyDecompositionComputer = viaCholeskyCroutForComplexNumbers<Number, MatrixWithProperties<ComplexNumber<Number>, Matrix>>()
            choleskyDecompositionComputer { matrix.get().choleskyDecomposition() }
        }
    }
}