        ...
        ParlettRecurrence(
            ...
            parlettRecurrenceAtomicBlockImageComputer = object : ParlettRecurrenceAtomicBlockImageComputer<ComplexNumber<Double>, Matrix> {
                override fun Matrix.atomicBlockImage(): Matrix {
                    ...
                    localContexts(
                        complexNumberField.numberDivideInt,
                        matrixCategoryOverField.matrixTimesInt
                    )
...
public object ExponentComputerSchurParlettUsingScalingAndSquaringSuppliableTopLevelFunctions {
    @Suppliable
