...
import dev.lounres.kone.multidimensionalCollections.experiment1.common.SettableMDList
import dev.lounres.kone.multidimensionalCollections.experiment1.common.SettableMDList1
import dev.lounres.kone.multidimensionalCollections.experiment1.common.SettableMDList2
import dev.lounres.kone.multidimensionalCollections.experiment1.common.SettableMDListTransformer
...
public class LazyArrayMDListTransformer<E> : SettableMDListTransformer<E> {
    override fun settableMdList(shape: Shape, initializer: (index: KoneUIntArray) -> E): SettableMDList<E> =
        LazyArrayMDList(shape = shape, generator = initializer)
    override fun settableMdList1(size: UInt, initializer: (index: UInt) -> E): SettableMDList1<E> =
        LazyArrayMDList1(size = size, generator = initializer)
    override fun settableMdList2(rowNumber: UInt, columnNumber: UInt, initializer: (rowIndex: UInt, columnIndex: UInt) -> E): SettableMDList2<E> =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LazyArrayMDListTransformer<*>
    }
