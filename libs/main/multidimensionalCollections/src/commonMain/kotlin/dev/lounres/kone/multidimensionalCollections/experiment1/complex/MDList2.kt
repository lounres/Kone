...
import dev.lounres.kone.collections.common.implementations.KoneVirtualList
...
public interface MDList2<E>: MDList<E> {
    ...
    public val rows: KoneIterableList<KoneIterableList<E>>
        get() = KoneVirtualList(rowNumber) { row -> KoneVirtualList(columnNumber) { column -> get(row, column) } }
    public val columns: KoneIterableList<KoneIterableList<E>>
