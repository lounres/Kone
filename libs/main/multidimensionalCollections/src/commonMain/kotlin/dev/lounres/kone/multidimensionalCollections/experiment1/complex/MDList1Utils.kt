...
public fun <E> MDList1(vararg elements: E, context: Equality<E> = defaultEquality()): MDList1<E> =
    ArrayMDList1(elements.size.toUInt(), context = context) { index -> elements[index.toInt()] }
public fun <E> MDList1(size: UInt, context: Equality<E> = defaultEquality(), initializer: (coefficient: UInt) -> E): MDList1<E> =
