...
public interface MDListTransformer : KoneContext {
    public fun <E> mdList(shape: Shape, initializer: (index: KoneUIntArray) -> E): MDList<E>
    ...
    public fun <E> MDList<E>.mapIndexed(context: Equality<E> = defaultEquality(), transform: (index: KoneUIntArray, E) -> E): MDList<E> = mdList(shape) { index -> transform(index, get(index)) }
...
public interface SettableMDListTransformer : MDListTransformer {
    override fun <E> mdList(shape: Shape, initializer: (index: KoneUIntArray) -> E): MDList<E> =
    ...
    public fun <E> settableMdList(shape: Shape, initializer: (index: KoneUIntArray) -> E): SettableMDList<E>
