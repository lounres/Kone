...
public fun <N, A: Ring<N>> A.vectorSpace(
...
context(VectorSpace<N, *>)
public val <N> Matrix<N>.transpose: Matrix<N>
...
context(VectorSpace<N, *>)
public val <N> Matrix<N>.reciprocal: Matrix<N>
...
context(VectorSpace<N, *>)
public val <N> Matrix<N>.adjugate: Matrix<N>
...
context(VectorSpace<N, *>)
public val <N> Matrix<N>.minor: MatrixMinorComputerFeature<N>
