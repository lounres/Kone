...
private class ColumnVectorEquality<N>(elementEquality: Equality<N>) : Equality<ColumnVector<N>> {
...
public fun <N> ColumnVector.Companion.equality(elementEquality: Equality<N>): Equality<ColumnVector<N>> =
    ColumnVectorEquality(elementEquality)

private class ColumnVectorHashing<N>(elementHashing: Hashing<N>) : Hashing<ColumnVector<N>> {
...
public fun <N> ColumnVector.Companion.hashing(elementHashing: Hashing<N>): Hashing<ColumnVector<N>> =
