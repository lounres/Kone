...
object DefaultDescription : SortingDescription {
    ...
    override val applier: SortingApplier = object : SortingApplier {
        ...
        override fun <E> sort(order: Order<E>, list: KoneSettableList<E>) = context(order) { list.sort() }
        override fun <E> sortWith(list: KoneSettableList<E>, comparator: dev.lounres.kone.comparison.Comparator<E>) = list.sortWith(comparator)
        override fun <E: Comparable<E>> sortDescending(list: KoneSettableList<E>) = list.sortDescending()
        override fun <E> sortDescending(order: Order<E>, list: KoneSettableList<E>) = context(order) { list.sortDescending() }
        override fun <E> sortWithDescending(list: KoneSettableList<E>, comparator: dev.lounres.kone.comparison.Comparator<E>) = list.sortWithDescending(comparator)
        override fun <E, R: Comparable<R>> sortBy(list: KoneSettableList<E>, selector: (E) -> R) = list.sortBy(selector)
        override fun <E, R> sortBy(order: Order<R>, list: KoneSettableList<E>, selector: (E) -> R) = context(order) { list.sortBy(selector) }
        override fun <E, R> sortWithBy(list: KoneSettableList<E>, comparator: dev.lounres.kone.comparison.Comparator<R>, selector: (E) -> R) = list.sortWithBy(comparator, selector)
        override fun <E, R: Comparable<R>> sortByDescending(list: KoneSettableList<E>, selector: (E) -> R) = list.sortByDescending(selector)
        override fun <E, R> sortByDescending(order: Order<R>, list: KoneSettableList<E>, selector: (E) -> R) = context(order) { list.sortByDescending(selector) }
        override fun <E, R> sortWithByDescending(list: KoneSettableList<E>, comparator: dev.lounres.kone.comparison.Comparator<R>, selector: (E) -> R) = list.sortWithByDescending(comparator, selector)
        
        override fun <E: Comparable<E>> sorted(list: KoneIterable<E>): KoneList<E> = list.sorted()
        override fun <E> sorted(order: Order<E>, list: KoneIterable<E>): KoneList<E> = context(order) { list.sorted() }
        override fun <E> sortedWith(list: KoneIterable<E>, comparator: dev.lounres.kone.comparison.Comparator<E>): KoneList<E> = list.sortedWith(comparator)
        override fun <E: Comparable<E>> sortedDescending(list: KoneIterable<E>): KoneList<E> = list.sortedDescending()
        override fun <E> sortedDescending(order: Order<E>, list: KoneIterable<E>): KoneList<E> = context(order) { list.sortedDescending() }
        override fun <E> sortedWithDescending(list: KoneIterable<E>, comparator: dev.lounres.kone.comparison.Comparator<E>): KoneList<E> = list.sortedWithDescending(comparator)
        override fun <E, R: Comparable<R>> sortedBy(list: KoneIterable<E>, selector: (E) -> R): KoneList<E> = list.sortedBy(selector)
        override fun <E, R> sortedBy(order: Order<R>, list: KoneIterable<E>, selector: (E) -> R): KoneList<E> = context(order) { list.sortedBy(selector) }
        override fun <E, R> sortedWithBy(list: KoneIterable<E>, comparator: dev.lounres.kone.comparison.Comparator<R>, selector: (E) -> R): KoneList<E> = list.sortedWithBy(comparator, selector)
        ...
        override fun <E, R> sortedByDescending(order: Order<R>, list: KoneIterable<E>, selector: (E) -> R): KoneList<E> = context(order) { list.sortedByDescending(selector) }
