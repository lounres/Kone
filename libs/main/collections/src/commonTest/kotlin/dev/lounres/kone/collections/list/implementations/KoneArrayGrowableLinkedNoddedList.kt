...
object KoneArrayGrowableLinkedNoddedListDescription : ListImplementationDescription, DequeImplementationDescription {
    ...
    override val dequeProducer: KoneDequeProducer = object : KoneDequeProducer.KoneGrowableDequeProducer {
        override fun <Element> produce(): KoneDeque<Element> = KoneArrayGrowableLinkedNoddedList()
        override fun <Element> produce(initialCapacity: UInt): KoneDeque<Element> = KoneArrayGrowableLinkedNoddedList(initialCapacity)
    }
    override val dequeValidator: KoneDequeValidator = object : KoneDequeValidator {
        override fun <Element: Any> validate(list: KoneDeque<Element>) {
            if (list !is KoneArrayGrowableLinkedNoddedList<Element>) fail("The list is invalid")
            Validator.validate(list)
        }
    }
}