...
object QuicksortingDescription : SortingDescription {
    ...
    override val applier: SortingApplier = object : SortingApplier {
        ...
        override fun <E> sort(order: Order<E>, list: KoneSettableList<E>) = order { list.quicksort() }
        ...
        override fun <E> sortDescending(order: Order<E>, list: KoneSettableList<E>) = order { list.quicksortDescending() }
        ...
        override fun <E, R> sortBy(order: Order<R>, list: KoneSettableList<E>, selector: (E) -> R) = order { list.quicksortByDescending(selector) }
        ...
        override fun <E, R> sortByDescending(order: Order<R>, list: KoneSettableList<E>, selector: (E) -> R) = order { list.quicksortByDescending(selector) }
        ...
        override fun <E> sorted(order: Order<E>, list: KoneIterable<E>): KoneList<E> = order { list.quicksorted() }
        ...
        override fun <E> sortedDescending(order: Order<E>, list: KoneIterable<E>): KoneList<E> = order { list.quicksortedDescending() }
        ...
        override fun <E, R> sortedBy(order: Order<R>, list: KoneIterable<E>, selector: (E) -> R): KoneList<E> = order { list.quicksortedBy(selector) }
        ...
        override fun <E, R> sortedByDescending(order: Order<R>, list: KoneIterable<E>, selector: (E) -> R): KoneList<E> = order { list.quicksortedByDescending(selector) }
