...
public inline fun <E> KoneList<E>.filter(predicate: (E) -> Boolean): KoneIterableList<E> =
    filterTo(koneMutableIterableListOf(), predicate)
public inline fun <E> KoneIterableList<E>.filter(predicate: (E) -> Boolean): KoneIterableList<E> =
    filterTo(koneMutableIterableListOf(), predicate)
...
public inline fun <E, R> KoneIterable<E>.runningFoldIndexed(initial: R, operation: (index: UInt, acc: R, E) -> R): KoneIterableList<R> {
    val result = KoneGrowableArrayList(1u) { initial }
    var accumulator = initial
    var index = 0u
    for (element in this) {
...
public inline fun <E, R> KoneList<E>.runningFoldIndexed(initial: R, operation: (index: UInt, acc: R, E) -> R): KoneIterableList<R> {
    val result = KoneSettableIterableList(size + 1u) { initial }
    var accumulator = initial
    for (index in indices) {
...
public inline fun <E, R> KoneIterableCollection<E>.runningFoldIndexed(initial: R, operation: (index: UInt, acc: R, E) -> R): KoneIterableList<R> {
    val result = KoneSettableIterableList(size + 1u) { initial }
    var accumulator = initial
    var index = 0u
    for (element in this) {
...
public inline fun <E, R> KoneIterableList<E>.runningFoldIndexed(initial: R, operation: (index: UInt, acc: R, E) -> R): KoneIterableList<R> {
    val result = KoneSettableIterableList(size + 1u) { initial }
    var accumulator = initial
    var index = 0u
    for (element in this) {
