...
internal /*const*/ val FIBONACCI_NUMBERS: KoneUIntArray = KoneUIntArray.of(
    ...
    17711u, 28657u, 46368u, 75025u, 121393u, 196418u, 317811u, 514229u, 832040u, 1346269u, 2178309u, 3524578u, 5702887u,
    9227465u, 14930352u, 24157817u, 39088169u, 63245986u, 102334155u, 165580141u, 267914296u, 433494437u, 701408733u,
    1134903170u, 1836311903u, 2971215073u,
)

@PublishedApi
internal fun fibonacciNumberGreaterOrEqualTo(number: UInt): UInt = FIBONACCI_NUMBERS.firstThat { it >= number }

@PublishedApi
internal fun fibonacciNumberIndexGreaterOrEqualTo(number: UInt): UInt = FIBONACCI_NUMBERS.firstIndexThat { _, fib -> fib >= number }
