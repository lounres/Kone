...
public inline fun <reified E> KoneIterable<E>.toKoneMutableArray(context: Equality<E> = defaultEquality()): KoneMutableArray<E> {
    if (this is KoneIterableCollection<E>) return this.toKoneMutableArray()

    val result = KoneGrowableArrayList(context = context)
