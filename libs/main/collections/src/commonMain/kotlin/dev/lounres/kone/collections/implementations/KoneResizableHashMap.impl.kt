...
//            array[i.toInt()] = null
    ...
    override val keysView: KoneIterableSet<K> get() = KeysSet()
    override val valuesView: KoneIterableCollection<V> get() = ValueCollection()
    override val entriesView: KoneIterableSet<KoneMapEntry<K, V>> get() = EntriesSet()
