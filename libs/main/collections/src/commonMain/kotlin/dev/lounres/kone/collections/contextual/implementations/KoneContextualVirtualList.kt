...
public class KoneContextualVirtualList<out E>(override val size: UInt, private val generator: (UInt) -> E):
    KoneContextualIterableList<E, Equality<E>> {
