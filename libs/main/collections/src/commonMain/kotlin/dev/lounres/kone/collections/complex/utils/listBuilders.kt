...
public fun <E> emptyKoneIterableList(context: Equality<E>): KoneIterableList<E> =
    EmptyKoneIterableList(context = context)
context(Equality<E>)
public fun <E> emptyKoneIterableList(): KoneIterableList<E> = EmptyKoneIterableList(context = this@Equality)

public fun <E> KoneIterableList(size: UInt, context: Equality<E>, initializer: (index: UInt) -> E): KoneIterableList<E> =
    KoneSettableArrayList(size, context, initializer)
context(Equality<E>)
public fun <E> KoneIterableList(size: UInt, initializer: (index: UInt) -> E): KoneIterableList<E> =
    KoneSettableArrayList(size, this@Equality, initializer)
public fun <E> KoneSettableIterableList(size: UInt, context: Equality<E>, initializer: (index: UInt) -> E): KoneSettableIterableList<E> =
    KoneSettableArrayList(size, context, initializer)
context(Equality<E>)
public fun <E> KoneSettableIterableList(size: UInt, initializer: (index: UInt) -> E): KoneSettableIterableList<E> =
    KoneSettableArrayList(size, this@Equality, initializer)
public fun <E> KoneMutableIterableList(size: UInt, context: Equality<E>, initializer: (index: UInt) -> E): KoneMutableIterableList<E> =
    KoneGrowableArrayList(size, context, initializer)
context(Equality<E>)
public fun <E> KoneMutableIterableList(size: UInt, initializer: (index: UInt) -> E): KoneMutableIterableList<E> =
    KoneGrowableArrayList(size, this@Equality, initializer)

public fun <E> koneIterableListOf(context: Equality<E>): KoneIterableList<E> = emptyKoneIterableList(context = context)
context(Equality<E>)
...
public fun <E> koneIterableListOf(vararg elements: E): KoneIterableList<E> =
    KoneSettableArrayList(KoneMutableArray(elements as Array<Any?>), context = this@Equality)
@Suppress("UNCHECKED_CAST")
...
context(Equality<E>)
public fun <E> koneMutableIterableListOf(): KoneMutableIterableList<E> =
    KoneGrowableArrayList(context = this@Equality)
...
public fun <E> koneMutableIterableListOf(vararg elements: E): KoneMutableIterableList<E> =
    KoneGrowableArrayList(elements.size.toUInt(), context = this@Equality) { elements[it.toInt()] }
...
public fun <E> KoneIterableCollection<E>.toKoneMutableIterableList(context: Equality<E> = this.context): KoneMutableIterableList<E> {
...
public fun <E> KoneList<E>.toKoneMutableIterableList(context: Equality<E> = this.context): KoneMutableIterableList<E> =
    KoneGrowableArrayList(size, context = context) { this[it] }
public fun <E> KoneIterableList<E>.toKoneMutableIterableList(context: Equality<E> = this.context): KoneMutableIterableList<E> {
    val iterator = iterator()
    return KoneGrowableArrayList(size, context = context) { iterator.next() }
}
...
public fun <E> KoneIterableCollection<E>.toKoneIterableList(context: Equality<E> = this.context): KoneIterableList<E> =
    if(size == 0u) emptyKoneIterableList(context = context)
    else this.toKoneMutableIterableList(context = context)
public fun <E> Collection<E>.toKoneIterableList(context: Equality<E> = defaultEquality()): KoneIterableList<E> =
    if(size == 0) emptyKoneIterableList(context = context)
    else this.toKoneMutableIterableList(context = context)
public fun <E> KoneList<E>.toKoneIterableList(context: Equality<E> = this.context): KoneIterableList<E> =
    if(size == 0u) emptyKoneIterableList(context = context)
    else this.toKoneMutableIterableList(context = context)
public fun <E> KoneIterableList<E>.toKoneIterableList(context: Equality<E> = this.context): KoneIterableList<E> =
    if(size == 0u) emptyKoneIterableList(context = context)
    else this.toKoneMutableIterableList(context = context)
