...
//    override val registrationsView: KoneSet<KoneMutableRegistration<E>> = Registrations()
...
//    }
//
//    internal inner class Registrations: KoneSet<Registration> {
//        override val size: UInt get() = this@KoneResizableLinkedArrayListRegistry.size
//        override fun contains(element: KoneResizableLinkedArrayListRegistry<E>.Registration): Boolean {
