...
import dev.lounres.kone.collections.common.KoneSettableIterableList
...
public class KoneLazyList<E>(override val size: UInt, private val generator: (UInt) -> E): KoneSettableIterableList<E> {
