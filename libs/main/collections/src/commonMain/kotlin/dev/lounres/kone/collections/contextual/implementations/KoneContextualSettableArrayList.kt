...
public /*value*/ class KoneContextualSettableArrayList<E> internal constructor(private val data: KoneContextualMutableArray<Any?>): KoneContextualSettableIterableList<E, Equality<E>> {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        when (other) {
            is KoneContextualSettableArrayList<*> ->
                for (i in 0u..<size) {
    ...
    internal class Iterator<E>(val data: KoneContextualMutableArray<Any?>, var currentIndex: UInt = 0u): KoneSettableLinearIterator<E> {
        init {
