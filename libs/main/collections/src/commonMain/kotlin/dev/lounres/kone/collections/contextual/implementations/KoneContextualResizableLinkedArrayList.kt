...
public class KoneContextualResizableLinkedArrayList<E> internal constructor(
    size: UInt,
    ...
    private var nextCellIndex: KoneContextualMutableUIntArray = KoneContextualMutableUIntArray(sizeUpperBound) { if (it == sizeUpperBound-1u) 0u else it + 1u },
    private var previousCellIndex: KoneContextualMutableUIntArray = KoneContextualMutableUIntArray(sizeUpperBound) { if (it == 0u) sizeUpperBound - 1u else it - 1u },
    ...
    private inline fun reinitializeData(oldSize: UInt = this.size, newDataSize: UInt = sizeUpperBound, generator: KoneContextualMutableArray<Any?>.(index: UInt) -> Any?) {
        ...
        nextCellIndex = KoneContextualMutableUIntArray(sizeUpperBound) { if (it == sizeUpperBound-1u) 0u else it + 1u }
        previousCellIndex = KoneContextualMutableUIntArray(sizeUpperBound) { if (it == 0u) sizeUpperBound - 1u else it - 1u }
        start = 0u
    }
    ...
    override fun remove(element: E) {
        ...
        scope {
            ...
            for (i in 0u ..< size) {
                if ((data[actualCurrentIndex] as E) eq element) {
                    targetIndex = i
    ...
    override fun equals(other: Any?): Boolean {
        ...
        when (other) {
            is KoneContextualResizableLinkedArrayList<*> -> {
