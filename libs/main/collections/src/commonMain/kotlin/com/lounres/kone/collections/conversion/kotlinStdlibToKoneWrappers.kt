...
package com.lounres.kone.collections.conversion
...
internal class KoneWrapperMutableIterableCollection<E>(private val collection: MutableCollection<E>): KoneRemovableIterableCollection<E> {
    override val size: UInt get() = collection.size.toUInt()
    override fun isEmpty(): Boolean = collection.isEmpty()
...
internal class KoneWrapperMutableList<E>(private val list: MutableList<E>): KoneMutableIterableList<E> {
    ...
    override fun add(index: UInt, element: E) { list.add(index.toInt(), element) }
