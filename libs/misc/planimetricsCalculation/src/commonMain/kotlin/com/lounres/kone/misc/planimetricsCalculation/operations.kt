 ...
 * @usesMathJax
 */
public fun <V> PlanimetricsCalculationContext<V, *>.divideSegmentInRatio(A: Point<V>, B: Point<V>, lambda: V): Point<V> = polynomialSpace {
    Point(
 ...
 * @usesMathJax
 */
public fun <V> PlanimetricsCalculationContext<V, *>.divideSegmentInRatio(A: Point<V>, B: Point<V>, a: V, b: V): Point<V> = polynomialSpace {
    Point(
        A.x * B.z * b + B.x * A.z * a,
        A.y * B.z * b + B.y * A.z * a,
        (a + b) * A.z * B.z
...
// TODO: Docs
public fun <V> PlanimetricsCalculationContext<V, *>.parallelismCondition(l: Line<V>, m: Line<V>): LabeledPolynomial<V> = polynomialSpace {
    l.x * m.y - l.y * m.x
}

// TODO: Docs
public fun <V> PlanimetricsCalculationContext<V, *>.parallelismTest(l: Line<V>, m: Line<V>): Boolean = polynomialSpace {
    parallelismCondition(l, m).isZero()
}

//// TODO: Docs
//public inline infix fun <V> Line<V>.isParallelTo(other: Line<V>): Boolean = parallelismTest(this, other)
...
// TODO: Docs
public fun <V> PlanimetricsCalculationContext<V, *>.perpendicularityCondition(l: Line<V>, m: Line<V>): LabeledPolynomial<V> = polynomialSpace {
    l.x * m.x + l.y * m.y
}

// TODO: Docs
public fun <V> PlanimetricsCalculationContext<V, *>.perpendicularityTest(l: Line<V>, m: Line<V>): Boolean = polynomialSpace {
    perpendicularityCondition(l, m).isZero()
}

//// TODO: Docs
//public inline infix fun <V> Line<V>.isPerpendicularTo(other: Line<V>): Boolean = perpendicularityTest(this, other)
